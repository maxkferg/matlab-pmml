...
were initialized from a PMML file, a trained GPML model.
...
# GPML Support
This package is designed to work flawlessly with the GPML pacakge. GPML objects can easily be converted
